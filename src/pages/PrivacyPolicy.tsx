    ...
    <div className="h-screen w-screen overflow-hidden relative flex items-center justify-center bg-background">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-8 h-[calc(100vh-260px)] overflow-y-auto mt-24">
        <div className="text-left space-y-6 pb-8">
          ...
          <p className="text-sm">This website is for information purposes only.</p>
          
          <p className="text-sm">You can visit our website without having to provide any personal details.</p>
          
          <p className="text-sm">Our website does not use any cookies. No data is collected or analysed from visitors to the website.</p>
        </div>
      </main>
