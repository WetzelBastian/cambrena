  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative flex items-center justify-center">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-8 text-center">
        ...
        <div className="text-left space-y-6 pb-8 h-[calc(100vh-280px)] overflow-y-auto">
          ...
          <section>
            ...
            <p className="text-sm">This privacy policy may be updated from time to time. We will post the revised version on our website and update the "Effective Date" at the top of the page. We encourage you to review this policy periodically.</p>
          </section>
        </div>
      </main>
